...
print(f"nHasil panen jagung dari lokasi2: {data_panen['lokasi2']['hasil_panen']['jagung']}")

# 3. Menampikan nama lokasi dari lokasi3
print(f"nNama Lokasi dari lokasi3: {data_panen['lokasi3']['nama_lokasi']}")
